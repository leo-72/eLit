...
import com.android.elit.adapter.BooksAdminAdapter
...
class BooksAdminFragment : Fragment() {
    ...
    private lateinit var booksAdminAdapter: BooksAdminAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            booksAdminAdapter = BooksAdminAdapter(booksList)
            recyclerView.adapter = booksAdminAdapter
        }
    ...
    private fun listBook() {
        ...
        booksRepository.getBooks().get().addOnSuccessListener { result ->
            ...
            if (!result.isEmpty) {
                ...
                booksAdminAdapter.notifyDataSetChanged()
    ...
    private fun updateDataFs() {
        ...
        listenerRegistration = query.addSnapshotListener { snapshot, exception ->
            ...
            if (snapshot != null) {
                ...
                booksAdminAdapter.updateData(books)
            }
        }
    }
    ...
    override fun onStart() {
        super.onStart()
        booksAdminAdapter.startListening()
    }

    override fun onStop() {
        super.onStop()
        booksAdminAdapter.stopListening()
    }
