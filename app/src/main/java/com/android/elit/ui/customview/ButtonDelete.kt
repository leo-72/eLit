...
class ButtonDelete : AppCompatButton {
    ...
    private fun init() {
        ...
        enabledBg = ContextCompat.getDrawable(context, R.drawable.bg_btn_delete_enable) as Drawable
        disabledBg = ContextCompat.getDrawable(context, R.drawable.bg_btn_delete_disable) as Drawable
    }
}